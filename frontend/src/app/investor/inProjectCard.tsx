            ...
            {(onClose) => (
              <>
                ...
                <ModalBody>
                  ...
                  />
                  {isInvestor && (
                    <Button variant="flat" className="font-semibold w-auto mt-2 hover:bg-orange-500" onClick={(e)=>inputProps.handleFunding(inputProps.id,inputProps.reqFunding)}>
                      Fund this idea Again 💸
                    </Button>
                  )}
                </ModalBody>
              </>
